...
export type WorkspaceByIdQuery = { __typename?: 'Query', workspaceByID: { __typename?: 'Workspace', id: any, name: string, createdBy: string, channels: Array<{ __typename?: 'Channel', id: any, name: string, type: ChannelType }> } };
